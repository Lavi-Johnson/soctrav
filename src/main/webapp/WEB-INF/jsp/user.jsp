            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="divider"></li>
                        <li>
                            <form action="../logout" method="POST"><i class="fa fa-fw fa-power-off"></i> <a href="#" onclick="this.parentNode.submit()">Log Out</a><input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"></input></form>
                        </li>
                    </ul>
                </li>
            </ul>
