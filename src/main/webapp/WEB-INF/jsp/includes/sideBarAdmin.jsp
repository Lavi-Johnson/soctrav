...
<ul class="nav navbar-right top-nav">
	...
	<li class="dropdown"><a href="#" class="dropdown-toggle"
		data-toggle="dropdown"><i class="fa fa-user"></i> ${usrName} <b
			class="caret"></b></a>
		<ul class="dropdown-menu">
			...
			<li>
				<form action="../logout" method="POST">
					<i class="fa fa-fw fa-power-off"></i> <a href="#"
						onclick="this.parentNode.submit()">Log Out</a><input type="hidden"
...
<div class="collapse navbar-collapse navbar-ex1-collapse">
	<ul class="nav navbar-nav side-nav">
		...
		<li><a href="tables.html"><i class="fa fa-fw fa-table"></i>
				Tables</a></li>
		<li><a href="/admin/user.html"><i class="fa fa-fw fa-edit"></i>User
				Generation</a></li>
		<li class="active"><a href="/admin/room.html"><i
				class="fa fa-fw fa-edit"></i>Room Generation</a></li>
